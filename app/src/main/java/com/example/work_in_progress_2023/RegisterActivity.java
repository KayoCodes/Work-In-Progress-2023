...
public class RegisterActivity extends ComponentActivity {
    ...
    private boolean validation(){
        ...
        if(!nameInput.getText().toString().equals("") && !ageInput.getText().toString().equals("")&& !heightInput.getText().toString().equals("") && !weightInput.getText().toString().equals("") && !emailInput.getText().toString().equals("") && !passwordInput.getText().toString().equals("")){
           return true;
        }
        return false;
